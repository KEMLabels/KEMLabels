...
export default function PrivacyPolicy() {
    return (
        ...
        <div style={{padding:'0 5em'}}>
            ...
            <p>At LabelMaster, we are dedicated to safeguarding the privacy and security of our customers' personal information. This Privacy Policy outlines how we collect, use, disclose, and protect your data when you interact with our services. Please take a moment to read this policy carefully.</p>
            ...
            <ol>
                <li>Providing Services: We use your personal information to process and fulfill your orders, provide shipping and tracking services, and manage your LabelMaster account.</li>
                ...
                <li>Communication: We may send you service-related updates, notifications, and promotional materials relevant to your interactions with LabelMaster.</li>
            </ol>

            <h2>Your Choices and Rights:</h2>
            <ol>
                <li>Account Settings: You can review and update your account information through your LabelMaster account settings.</li>
                <li>Marketing Communications: You can opt-out of receiving marketing communications from LabelMaster by following the unsubscribe instructions included in the emails or contacting us directly.</li>
            ...
            <p>LabelMaster services are not intended for children under the age of 13, and we do not knowingly collect personal information from individuals in this age group.</p>
            ...
            <br></br>
            <p>By using LabelMaster services, you consent to the practices described in this Privacy Policy.</p>
        </div>
        </PageLayout>
    )
}